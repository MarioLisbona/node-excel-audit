...
export const embeddingsKnowledgeBase = [
  {
    input: {
      issuesIdentified:
        "The auditor has noted that the tax invoice listed the overall price as $0 while the List of Sites listed $1,500. Please clarify.",
    ...
    output: { auditorNotes: "Finding and recommendation", closedOut: "N" },
  },
  {
    input: {
      issuesIdentified:
  ...
  },
  {
    ...
    output: { auditorNotes: "No issues", closedOut: "Y" },
  },
  {
    input: {
      issuesIdentified:
  ...
  },
  {
    ...
    output: { auditorNotes: "Awaiting calculation RFI", closedOut: "N" },
  },
  {
    input: {
      issuesIdentified:
  ...
  },
  {
    ...
    output: {
      auditorNotes:
        "Finding and recommendation - documents have been corrected.",
      closedOut: "N",
    },
  },
];
